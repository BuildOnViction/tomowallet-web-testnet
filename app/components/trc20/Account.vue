<template>
  <div class="account">
    ...
    <div class="account-balance">
      ...
      <div class="account-balance-container">
        <div class="account-balance-number text-center" :style="{'font-size': `${tomoBalanceSize}px`}">
          <animated-number
          :value="tomoBalance"
          :formatValue="formatBalance"
          :duration="1000"
...
export default {
  props: ['address', 'balance', 'symbol', 'tomoBalance'],
  components: {
    Address,
    AnimatedNumber
  },
  computed: {
    ...
    tomoBalanceSize() {
      var s = this.formatBalance(this.tomoBalance);
      switch (s.length) {
        case 1: return 60;
        case 2: return 60;
        case 3: return 60;
