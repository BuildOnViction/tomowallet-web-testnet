<template>
  <div class="transfer">
    ...
    <div v-else>
      ...
      <div class="fs16 mt30">Amount (Not include Tx Fee: {{ fee }} {{ symbol }})</div>
      <div>
        <input
          ref="amountInput"
          ...
          placeholder="0"
          @change="changeAmount">
        <div class="transfer-symbol">{{ symbol }}</div>
...
export default {
  props: ['address', 'balance', 'isSending', 'error', 'explorer', 'fee', 'symbol'],
  data() {
    return {
      toAddress: '',
      amount: 0,
